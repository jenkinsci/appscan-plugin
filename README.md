...
-   [Plain text password shown in job configuration form
    fields](https://jenkins.io/security/advisory/2019-08-28/#SECURITY-1512){.external-link}
...
Cloud](https://cloud.appscan.com/AsoCUI/serviceui/home){.external-link}
service. You'll need to [create an
application](http://help.hcltechsw.com/appscan/ASoC/ent_create_application.html?query=create){.external-link}
on the service to associate your scans with.

## Usage

[This video](http://ibm.biz/ASoC-Jenkins){.external-link} demonstrates
installation and configuration of the plugin.

1.  Add your Application Security on Cloud credentials on the Jenkins
    **Credentials** page.
    -   From the main Jenkins dashboard, click the **Credentials** link.
    -   Add new global credentials.
    -   In the **Kind** drop-down list, select **IBM Application
        Security on Cloud Credentials**.
...
2.  Add a **Run Security Test** build step to your Jenkins project
    ...
    -   **Application:** Select the application to associate the scan
        with. NOTE: You must create at least 1 application in the [IBM
        Application Security on
        Cloud](https://appscan.ibmcloud.com){.external-link} service or
        ...
        -   **Dynamic Analyzer**
            ...
            -   **Additional Options**: If selected, the following
                ...
                -   **Presence**: If your app is not on the internet,
                    ...
                    available
                    [here](https://www.ibm.com/support/knowledgecenter/en/SSYJJF_1.0.0/ApplicationSecurityonCloud/asp_scanning.html#Scanning_p){.external-link}.
                -   **Scan File**: If you have an AppScan Standard scan
                    ...
                    files, see [this
                    topic](https://www.ibm.com/support/knowledgecenter/SSYJJF_1.0.0/ApplicationSecurityonCloud/asd_AppScanStandard.html#AppScanStandard){.external-link}.
        -   **Mobile Analyzer**
...
-   Update for
    [JEP-200](https://jenkins.io/blog/2018/01/13/jep-200/){.external-link}.
